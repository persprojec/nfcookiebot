...
async def process_file(
    ...
    async with httpx.AsyncClient(
        ...
        try:
            # 1) Inject cookies by hitting the base domain
            await client.get(
                "https://www.netflix.com",
                follow_redirects=True
            )
            # 2) Now request the account page
    ...
    if valid:
        ...
        full_caption = (
            ...
            + "\n\n"
            + "\n".join(section)
            + "\n\n📌 To know Service Code of this Netflix cookie account forward this file to @NetflixServiceRobot"
        )
